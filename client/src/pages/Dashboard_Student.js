          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to="/">Academic Fees</NavLink>
                </li>

                <li className="nav-item">
                  <NavLink className="nav-link" to="/">Academic Performance</NavLink>
                </li>

                <li className="nav-item">
                  <NavLink className="nav-link" to="/">Event</NavLink>
                </li>
              </ul>
        ...
        <div className="container px-4 py-5" id="featured-3">
          ...
          <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div className="feature col">
              ...
              <NavLink className="icon-link" to="/">More Details</NavLink>
            </div>
            ...
            <div className="feature col">
              ...
              <h3 className="fs-2 text-body-emphasis">Academic Performance</h3>
            ...
            <div className="feature col">
              <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                <img src="image/events.png" alt="Events" className="feature_au" />
              </div>
              <h3 className="fs-2 text-body-emphasis">Events</h3>
              <p>Details about other programme which are running in the Ahmedabad University.</p>
              <NavLink to="/" className="icon-link"> More Details</NavLink>
            </div>
